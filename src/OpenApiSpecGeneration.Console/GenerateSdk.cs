...
public class GenerateSdkSettings : CommandSettings
{
...
public class GenerateSdk : AsyncCommand<GenerateSdkSettings>
{
    public GenerateSdk()
    {
    }

    public override async Task<int> ExecuteAsync([NotNull] CommandContext context, [NotNull] GenerateSdkSettings settings)
    {
        try
        {
            AnsiConsole.MarkupLine("Generating SDK");
